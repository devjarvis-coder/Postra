...
import com.xcodelabs.postra.ViewFullImageActivity
...
// this adapter use for messaging this is connected in messagechatactivity.kt
class ChatsAdapter(
    mContext: Context,
    mChatlist: List<Chat>,
    imageUrl: String
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        return if (position == 1) {
            val view: View = LayoutInflater.from(mContext)
                .inflate(com.xcodelabs.postra.R.layout.message_item_right, parent, false)
            ViewHolder(view)
        } else {
            val view: View = LayoutInflater.from(mContext)
                .inflate(com.xcodelabs.postra.R.layout.message_item_left, parent, false)
            ViewHolder(view)
        }
    }
