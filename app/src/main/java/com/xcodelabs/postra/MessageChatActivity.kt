...
import com.xcodelabs.postra.Adapter.ChatsAdapter
import com.xcodelabs.postra.Fragments.APIService
import com.xcodelabs.postra.Model.Chat
import com.xcodelabs.postra.Model.User
import com.xcodelabs.postra.Notifications.*
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: Toolbar = findViewById(R.id.toolbar_register_message_chat)
        ...
        send_message_btn.setOnClickListener {
            ...
            if (message == "")
            {
                Toast.makeText(this@MessageChatActivity, "please write massage, first...", Toast.LENGTH_LONG).show()
            }
            else
            {
                sendMessageToUsers(firebaseUser!!.uid, userIdVisit, message)
            }
    ...
    private fun sendMessageToUsers(senderId: String, receiverId: String?, message: String)
    {
        ...
        query.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot)
            {
                for (dataSnapshot in p0.children)
                {
                    ...
                    apiService!!.sendNotiication(sender)
